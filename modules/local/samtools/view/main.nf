process SAMTOOLS_VIEW {
    ...
    readnames = targets ? "--targets-file ${targets} --output-unselected ${prefix}.unselected.${file_type}": ""
    ...
    unselected = targets ? "touch ${prefix}.unselected.${file_type}" : ""
    // Can't choose index type of unselected file
    unselected_index = targets && (args.contains("--write-index") || index_format) ? "touch ${prefix}.unselected.${file_type}.${default_index_format}" : ""
